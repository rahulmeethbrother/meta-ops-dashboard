  ...
  return <div className="builder-page">
    ...
    <div className="builder-layout">
      <section className="builder-form card">
        ...
        {planned && <div className="builder-success">Plan validated, not published: {plan.campaigns} campaigns, {plan.adsets} ad sets, {plan.ads} ads, {plan.images} source images, {plan.daily.toFixed(2)} daily budget. No processing job has started; live publishing still requires the build worker.</div>}
      </section>
